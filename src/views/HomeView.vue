  ...
  <div class="">
    ...
    <div class="px-36 flex flex-col gap-2 justify-center mt-10">
      ...
      <div class="flex gap-4">
        <CInput placeholder="Student Full Name" class="border-blue-500 w-full" label="Full name" />
        <CInput placeholder="Student LUC ID" class="border-blue-500 w-full" label="LUC ID" />
      </div>
      <div v-if="countryList.length" class="flex gap-4">
        <CInput placeholder="Student Passport" class="border-blue-500 w-full" label="Passport" />
        <CSelect
      ...
      <div v-if="programmList.length" class="flex gap-4">
        <CSelect
          ...
          class="w-full"
        />
        <CInput placeholder="Scholarship %" class="border-blue-500 w-full" label="Scholarship %" />
      </div>

      <div v-if="letterTypeLists.length" class="flex gap-4">
        <CSelect
          v-model="selectedLetterType"
          :options="letterTypeLists"
          label="Choose a letter type:"
          placeholder="Please select a letter type"
          class="w-full"
        />
        <CInput placeholder="Filled Date" class="border-blue-500 w-full" label="Filled date" />
      </div>
    ...
    content: [
      {
        ...
        columns: [
          ...
          },
          {
            ...
            table: {
              body: [
                [{ text: 'Our Reference:', bold: true }, 'LUC0805142024'],
                [{ text: 'Date:', bold: true }, 'Wednesday, August 7, 2024']
              ]
            },
            layout: 'Borders',
            margin: [170, 60, 10, 10]
      ...
      {
        text: 'AHMED JAMILA SAMIR FATOUH MEAWAD',
        style: 'normal',
        alignment: 'left',
        margin: [0, 0, 0, 2]
      },
      { text: 'A38477661', style: 'normal', alignment: 'left', padding: [0, 2, 0, 2] },
      { text: 'EGYPT', style: 'normal', alignment: 'left', margin: [0, 2, 0, 10] },
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              {
                text: 'Bachelor of Information Technology (Honours) (Internet Technology and Cloud Computing)',
                colSpan: 3,
                fontSize: 9,
                margin: [0, 6, 0, 2]
              },
              ...
              { text: '36 Months', colSpan: 1, fontSize: 9, margin: [0, 6, 0, 6] }
            ],
            [
              {
                text: 'Intake',
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              {
                text: 'Health Status Declaration Form* Download here',
                fontSize: 8,
                margin: [0, 5, 0, 0]
              },
              { image: iconImg, width: 20, height: 20, alignment: 'center' },
      ...
      {
        text: '* All documents must be color scanned (as per original size), including Passport pages and visa information pages, and emailed to imd@lincoln.edu.my',
        fontSize: 10,
        margin: [0, 20, 0, 20]
      },
      {
